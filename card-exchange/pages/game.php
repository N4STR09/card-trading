...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    while ($card = mysqli_fetch_assoc($cards_result)) {
        ...
        mysqli_query($conn, "INSERT INTO user_progress (user_id, progress) VALUES ('$user_id', 5) 
        ON DUPLICATE KEY UPDATE progress = progress + 5");
...
<body>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            ...
            let cardImages = [
                { value: "A", img: "../assets/img/card179.png" },
                { value: "A", img: "../assets/img/card179.png" },
                { value: "B", img: "../assets/img/card162.png" },
                { value: "B", img: "../assets/img/card162.png" },
                { value: "C", img: "../assets/img/card136.png" },
                { value: "C", img: "../assets/img/card136.png" },
                { value: "D", img: "../assets/img/card73.png" },
                { value: "D", img: "../assets/img/card73.png" },
                { value: "E", img: "../assets/img/card64.png" },
                { value: "E", img: "../assets/img/card64.png" },
                { value: "F", img: "../assets/img/card173.png" },
                { value: "F", img: "../assets/img/card173.png" }
            ];
            let flippedCards = [];
            let matchedPairs = 0;
